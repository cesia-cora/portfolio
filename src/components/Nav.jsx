...
export const Nav = () => {
    ...
    return (
        <>
            <nav id="navbar">
                    <span class="tooltip"><a href="#Index" alt="Inicio de página"><img src={Home} width="30"></img></a><span
                        class="tooltiptext">{t('nav.index')}</span></span>
                    <span class="tooltip"><a href="#About-me" alt="Sobre mi"><img src={About} width="30"></img></a><span
                        class="tooltiptext">{t('nav.aboutMe')}</span></span>
                    <span class="tooltip"><a href="#Skills" alt="Habilidades"><img src={Skill} width="30"></img></a><span
                        class="tooltiptext">{t('nav.skills')}</span></span>
                    <span class="tooltip"><a href="#Projects" alt="Proyectos"><img src={Project} width="30"></img></a><span
