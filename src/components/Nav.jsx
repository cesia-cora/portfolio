...
export const Nav = () => {
    ...
    return (
        <>
            <nav id="navbar">
                <span class="tooltip"><Link to={`/`}><a alt="Inicio de página"><img src={Home} width="40"></img></a></Link><span
                    class="tooltiptext">{t('nav.index')}</span></span>
                <span class="tooltip"><a href="#sobre-mi" alt="Sobre mi"><img src={About} width="40"></img></a><span
                    class="tooltiptext">{t('nav.aboutMe')}</span></span>
                <span class="tooltip"><Link to={`/skills`}><a alt="Habilidades"><img src={Skill} width="40"></img></a></Link><span
                ...
                <span class="tooltip"><Link to={`/projects`}><a alt="Proyectos"><img src={Project} width="40"></img></a></Link><span
                    class="tooltiptext">{t('nav.projects')}</span></span>
                <span class="tooltip"><Link to={`/contact`}><a alt="Contáctame"><img src={Adress} width="40"></img></a></Link><span
